        ...
        <div class="main" ref="main">
            <div class="text">
                ...
                <form @submit="send" class="form">
                    ...
                    <div class="buttons">
                        <div class="social">
                            <a class="email media" href="mailto:aul.faqih07@gmail" target="_blank">
                                <i class="fas fa-envelope"></i>
                            </a>
                            <a class="twitter media" href="https://twitter.com/m4saul" target="_blank">
                                <i class="fab fa-twitter"></i>
                            </a>
                            <a class="github media" href="https://github.com/masaul" target="_blank">
...
export default {
    ...
    methods: {
        send(e) {
            ...
            axios
                .post("https://formsubmit.co/ajax/aul.faqih07@gmail.com", {
                    name: this.name,
                    email: this.email,
